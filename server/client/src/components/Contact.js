            ...
            <div className='row'>
              ...
              onChange={handleInputs}  placeholder="Your name" required />
                        ...
                        <div className="contact_form_text mt-5">
                          <textarea className="text_field contact_form_message" name="message" value={userData.message}
                          onChange={handleInputs}
                              placeholder="Message" cols="30" rows="10"></textarea>
                        </div>

                        <div className="contact_form_button">
                          <button type="submit" className="button contact_submit_button" onChange={contactForm}
                          >Send Message</button>
                        </div>
                  </form>
                  </div>
